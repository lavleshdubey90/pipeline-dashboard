          ...
          {THEMES.map((t) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute top-2 right-2 w-4 h-4 sm:w-5 sm:h-5 rounded border-2 flex items-center justify-center transition-all ${
                    isActive
                ...
                <div className="flex flex-col items-center justify-center gap-2 h-full">
                  ...
                  <div
                    className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center shadow-md ${themePreviews[t.id]}`}
                  >
                    {themeIcons[t.id]}
                  </div>
