...
const JobRow: React.FC<JobRowProps> = ({ jobId }) => {
    ...
    return (
        <div
            ...
            className={`p-4 capitalize rounded-box cursor-pointer transition-all duration-200 border ${selectedJobId === job.id
        ...
        >
            <div className="flex items-start justify-between mb-2">
                ...
                <span className={`badge font-semibold badge-xs ${job.workplace === "Remote" ? "badge-info" :
                    job.workplace === "Hybrid" ? "badge-warning" : "badge-secondary"
                    }`}>{job.workplace}</span>
            </div>
