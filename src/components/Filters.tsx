...
import { type ScoreRange, useFilterStore } from "@/store/useFilterStore";
    ...
    <React.Fragment>
      <div className="py-4 px-2 overflow-x-scroll rounded-box flex gap-4">
        ...
        <select
          ...
          value={filters.stage}
          onChange={(e) =>
            setFilter("stage", e.target.value as CandidateStatus | "All")
          }
        >
        ...
        <select
          ...
          onChange={(e) =>
            setFilter("scoreRange", e.target.value as ScoreRange)
          }
        >
