...
const CandidateDetailsContent: React.FC<{ candidate: Candidate }> = ({
  candidate,
}) => {
  return (
    <div className="space-y-5">
      <div className="relative flex flex-col items-center">
        ...
        <h2 className="text-2xl md:text-3xl font-bold mt-5 text-center">
          {candidate.name}
        </h2>
    ...
    <div className="drawer drawer-end">
      ...
      <div className="drawer-content">
        <label
          ...
          className="drawer-button btn btn-link no-underline btn-sm"
        >
          View
        </label>
      </div>
