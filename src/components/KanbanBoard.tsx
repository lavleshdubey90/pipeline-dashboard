    ...
    <div className="flex gap-4 lg:gap-5 min-h-fit absolute">
      {CANDIDATE_STAGES.map((stage) => {
        ...
        return (
          ...
          >
            {/* Kanban Card Header */}
            <div className="px-4 rounded-t-box py-3 bg-linear-to-r from-base-200 to-base-100 border-b border-base-300 flex items-center justify-between">
