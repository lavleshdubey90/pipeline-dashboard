    ...
    <div className="card bg-linear-to-br from-base-100 to-base-200 border border-base-300">
      <div className="card-body p-5">
        ...
        <div className="flex items-center justify-between py-3 border-y border-base-300/50 mb-4">
          ...
          >
            <span
              className={`indicator-item status ${job.status === "active" ? "status-success" : job.status === "paused" ? "status-warning" : "status-error"}`}
            />
        ...
        <div className="drawer drawer-end">
          ...
          <div className="drawer-content flex justify-end">
            <label
              htmlFor={drawerId}
              className="drawer-button btn btn-primary btn-sm group/btn"
            >
