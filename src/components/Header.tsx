      ...
      <nav className="flex justify-between items-center">
        ...
        <div className="drawer drawer-end block md:hidden w-fit">
          ...
          <div className="drawer-content">
            ...
            <label
              htmlFor="sidebar"
              className="drawer-button btn btn-primary btn-square btn-link"
            >
              ...
              <div className="flex-1 flex flex-col justify-between w-full">
                ...
                <ul className="w-full menu p-0! space-y-2">
                  {SIDEBAR_MAIN_LINKS.map((link) => (
                    <li key={link.href} className="w-full" data-tip={link.name}>
                      <Link
                        href={link.href}
                        onClick={() => setIsDrawerOpen(false)}
                        className={`p-3 gap-4 rounded-box ${pathname === link.href ? "bg-primary text-primary-content" : ""}`}
                      >
